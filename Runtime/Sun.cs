...
namespace ams {
  ...
  public class Sun : MonoBehaviour {
    ...
    [SerializeField] bool realDateTime;

    [SerializeField] Month month;
    
    [SerializeField, Range(1, 31)] int day = 1;
    ...
    [SerializeField] int frameSteps = 1;
    int frameStep;
    ...
    private void Awake() {
      ...
      var setDate = new DateTime(DateTime.Now.Year, (int)month, day, hour, minutes, 0);
      time = realDateTime ? DateTime.Now : setDate;
      hour = time.Hour;
      minutes = time.Minute;
      date = time.Date;
    }
    ...
    private void OnValidate() {
      var newDate = new DateTime(date.Year, (int)month, day, hour, minutes, 0);
      int days = (newDate - date).Days;
      days = days >= 0 && !realDateTime ? days : 0;
      time = date + new TimeSpan(days, hour, minutes, 0);
